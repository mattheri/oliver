...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app/auth/routes/($locale).auth.logout.route.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703208537401.11";
}
function Logout() {
...
//# sourceMappingURL=/build/($locale).auth.logout-43CFXCBH.js.map
