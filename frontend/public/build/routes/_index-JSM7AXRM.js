...
import "/build/_shared/chunk-OVNFYIRE.js";
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\common\\\\components\\\\Slider\\\\SliderArrowNext.tsx"' + id);
  };
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704756518961.607";
}
function SliderArrowNext({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { ...rest, className: twMerge("absolute right-1 top-1/2 z-1 h-fit w-fit -translate-y-1/2 rounded-full bg-white shadow-lg before:content-none hover:bg-white focus:bg-white focus:ring-1", className, additionalClassName), children: /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(ArrowRightIcon_default, { className: "h-8 w-8 text-gray-500", "aria-hidden": "true" }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\common\\\\components\\\\Slider\\\\SliderArrowPrevious.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
function SliderArrowNext2({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)("button", { ...rest, className: twMerge("absolute left-1 top-1/2 z-1 h-fit w-fit -translate-y-1/2 rounded-full bg-white shadow-lg before:content-none hover:bg-white focus:bg-white focus:ring-1", className, additionalClassName), children: /* @__PURE__ */ (0, import_jsx_dev_runtime2.jsxDEV)(ArrowLeftIcon_default, { className: "h-8 w-8 text-gray-500", "aria-hidden": "true" }, void 0, false, {
...
_c2 = SliderArrowNext2;
var _c2;
$RefreshReg$(_c2, "SliderArrowNext");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\common\\\\components\\\\Slider\\\\SliderDotsContainer.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
function SliderDotsContainer({
  children
}) {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime3.jsxDEV)("ul", { className: "scrollbar-hide flex w-full justify-center gap-4 overflow-y-hidden overflow-x-scroll py-[3px] [&_li]:h-4 [&_li]:w-4", children }, void 0, false, {
    fileName: "app/common/components/Slider/SliderDotsContainer.tsx",
    lineNumber: 24,
    columnNumber: 10
  }, this);
}
_c3 = SliderDotsContainer;
var _c3;
$RefreshReg$(_c3, "SliderDotsContainer");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\common\\\\components\\\\Slider\\\\SliderDot.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
function SliderDot({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)("button", { ...rest, className: twMerge("!h-3 !w-3 rounded-full !p-0 !outline !outline-1 !outline-black transition-colors duration-300 before:!content-none [.slick-active_&]:bg-black", className) }, void 0, false, {
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\common\\\\components\\\\Slider\\\\Slider.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
var Slider = _s((0, import_react.forwardRef)(_c5 = _s(({
  children,
  dots = true,
  infinite = true,
  speed = 500,
  slidesToShow = 1,
  slidesToScroll = 1,
  nextArrow = /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SliderArrowNext, {}, void 0, false, {
    fileName: "app/common/components/Slider/Slider.tsx",
    lineNumber: 35,
    columnNumber: 15
  }, this),
  prevArrow = /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SliderArrowNext2, {}, void 0, false, {
    fileName: "app/common/components/Slider/Slider.tsx",
    lineNumber: 36,
    columnNumber: 15
  }, this),
  appendDots = (dots2) => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SliderDotsContainer, { children: dots2 }, void 0, false, {
    fileName: "app/common/components/Slider/Slider.tsx",
    lineNumber: 37,
    columnNumber: 24
  }, this),
  customPaging = () => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SliderDot, {}, void 0, false, {
    fileName: "app/common/components/Slider/Slider.tsx",
    lineNumber: 38,
    columnNumber: 24
  }, this),
  ...
  (0, import_react.useEffect)(() => {
    const activeRef = (ref == null ? void 0 : ref.current) || sliderRef.current;
    activeRef.slickGoTo(0);
  }, [sliderRef, ref, ...deps]);
  return /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(import_react_slick.default, { ref: ref || sliderRef, dots, infinite, speed, slidesToShow, slidesToScroll, nextArrow, prevArrow, customPaging, appendDots, ...settings, children: import_react.Children.map(children, (child) => /* @__PURE__ */ (0, import_jsx_dev_runtime5.jsxDEV)(SlideAs, { children: child }, void 0, false, {
    fileName: "app/common/components/Slider/Slider.tsx",
    lineNumber: 51,
    columnNumber: 42
  }, this)) }, void 0, false, {
...
}, "ZJUOs54uyrVRVFn1eI1s3xtw2gw=")), "ZJUOs54uyrVRVFn1eI1s3xtw2gw=");
_c22 = Slider;
var Slider_default = _c32 = Object.assign(Slider, {
...
var _c22;
var _c32;
$RefreshReg$(_c5, "Slider$forwardRef");
$RefreshReg$(_c22, "Slider");
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706581844870.3516";
}
var LoaderService = class {
  ...
  async fromClient({
    ...
    try {
      ...
      const headerObj = Object.fromEntries(headers != null ? headers : []);
...
// app/http/service/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app\\http\\service\\index.ts"
  );
  import.meta.hot.lastModified = "1704756518976.1333";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706581852275.6023";
}
function useClientLoader() {
  const [loading, setLoading] = (0, import_react2.useState)(false);
  const [error, setError] = (0, import_react2.useState)(void 0);
  const controller = (0, import_react2.useRef)(new AbortController());
  const canDo = (0, import_react2.useRef)(true);
  const onRequestStart = (0, import_react2.useCallback)(() => {
    setLoading(true);
    canDo.current = false;
  }, []);
  const onRequestEnd = (0, import_react2.useCallback)(() => {
    setLoading(false);
  }, []);
  const onError = (0, import_react2.useCallback)((error2) => {
    setError(error2);
  }, []);
  const loaderService = (0, import_react2.useMemo)(() => new LoaderService(), []);
  const loader = (0, import_react2.useCallback)(
    (args) => {
...
// app/http/hooks/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app\\http\\hooks\\index.ts"
  );
  import.meta.hot.lastModified = "1704756518975.1328";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\http\\\\components\\\\HttpState\\\\HttpState.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704756518974.1333";
}
function HttpState({
  loading,
  error,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(If_default, { condition: !!error, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(If_default.Then, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)("div", { children: error == null ? void 0 : error.message }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(If_default.Else, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(If_default, { condition: loading, children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(If_default.Then, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(Loader, { show: loading }, void 0, false, {
        fileName: "app/http/components/HttpState/HttpState.tsx",
        lineNumber: 34,
        columnNumber: 13
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime6.jsxDEV)(If_default.Else, { children }, void 0, false, {
        fileName: "app/http/components/HttpState/HttpState.tsx",
        lineNumber: 36,
        columnNumber: 11
      }, this)
...
_c6 = HttpState;
var _c6;
$RefreshReg$(_c6, "HttpState");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;

// app/http/components/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app\\http\\components\\index.ts"
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706622582579.7432";
}
function useUrl() {
  const { url } = (0, import_react3.useContext)(HttpContext_default);
  return new URL(url);
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704766154314.6465";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706584670109.933";
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\recipes\\\\components\\\\RecipeCard\\\\RecipeCard.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704756518982.1333";
}
function RecipeCard({
  id,
  title,
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)(Link_default, { to, className: "block max-h-24 overflow-hidden", children: /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "flex", children: [
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "max-h-full flex-grow p-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("div", { className: "pb-2 text-left text-sm", children: title }, void 0, false, {
        fileName: "app/recipes/components/RecipeCard/RecipeCard.tsx",
        lineNumber: 44,
        columnNumber: 11
      }, this),
      /* @__PURE__ */ (0, import_jsx_dev_runtime7.jsxDEV)("p", { className: "line-clamp-2 text-sm", children: ingredients == null ? void 0 : ingredients.join(", ") }, void 0, false, {
        fileName: "app/recipes/components/RecipeCard/RecipeCard.tsx",
        lineNumber: 45,
        columnNumber: 11
      }, this)
...
_s2(RecipeCard, "75uCOgwSnlK7+kuCl0lbRfLaxZk=", false, function() {
  return [useRecipeUrl];
});
_c7 = RecipeCard;
var _c7;
$RefreshReg$(_c7, "RecipeCard");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\recipes\\\\components\\\\RandomRecipesSlider\\\\RandomRecipesSlider.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1705974044614.1";
}
...
function RandomRecipesSlider({
  ...
  const [randomRecipes, setRandomRecipes] = (0, import_react4.useState)([]);
  ...
  }], className: "isolate py-2", children: randomRecipes.map((recipe) => /* @__PURE__ */ (0, import_jsx_dev_runtime8.jsxDEV)(RecipeCard, { id: recipe.id, ingredients: recipe.ingredients, isExternalSrc: recipe.isExternalSrc, title: recipe.title, image: recipe.image }, recipe.id, false, {
...
_s3(RandomRecipesSlider, "FlyqeoxLZIq424IpCUPmLmSCPEc=", false, function() {
  return [useClientLoader];
});
_c8 = RandomRecipesSlider;
var _c8;
$RefreshReg$(_c8, "RandomRecipesSlider");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\recipes\\\\components\\\\EmptyRecipesDashboard\\\\EmptyRecipesDashboard.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704756518980.1333";
}
function EmptyRecipesDashboard() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { className: "relative", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("h2", { className: "text-base font-semibold leading-6 text-gray-900", children: "Recipes" }, void 0, false, {
      fileName: "app/recipes/components/EmptyRecipesDashboard/EmptyRecipesDashboard.tsx",
      lineNumber: 26,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("p", { className: "mt-1 text-sm text-gray-500", children: "You didn\u2019t add any recipes yet. Start by adding your first recipe." }, void 0, false, {
      fileName: "app/recipes/components/EmptyRecipesDashboard/EmptyRecipesDashboard.tsx",
      lineNumber: 29,
      columnNumber: 7
    }, this),
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("ul", { className: "mt-6 grid grid-cols-1 gap-6 border-b border-t border-gray-200 py-6 sm:grid-cols-2", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("li", { className: "flow-root", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(ActionCard, { heading: "Add a custom recipe", description: "Create a custom recipe from scratch.", to: "/recipes/custom/create", icon: PencilIcon_default }, void 0, false, {
        fileName: "app/recipes/components/EmptyRecipesDashboard/EmptyRecipesDashboard.tsx",
        lineNumber: 34,
        columnNumber: 11
      }, this) }, void 0, false, {
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("li", { className: "flow-root", children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(ActionCard, { heading: "Add a recipe from a URL", description: "Import a recipe from a URL.", to: "/recipes/url/create", icon: LinkIcon_default, background: "bg-green-500" }, void 0, false, {
        fileName: "app/recipes/components/EmptyRecipesDashboard/EmptyRecipesDashboard.tsx",
        lineNumber: 37,
        columnNumber: 11
      }, this) }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime9.jsxDEV)(RandomRecipesSlider, {}, void 0, false, {
      fileName: "app/recipes/components/EmptyRecipesDashboard/EmptyRecipesDashboard.tsx",
      lineNumber: 41,
      columnNumber: 9
    }, this) }, void 0, false, {
...
_c9 = EmptyRecipesDashboard;
var _c9;
$RefreshReg$(_c9, "EmptyRecipesDashboard");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704756518985.6497";
}
function useRecipes() {
  const {
    data: {
  ...
  } = (0, import_react5.useContext)(AppContext_default);
  return recipes;
}
...
if (!window.$RefreshReg$ || !window.$RefreshSig$ || !window.$RefreshRuntime$) {
  ...
  prevRefreshSig = window.$RefreshSig$;
  window.$RefreshReg$ = (type, id) => {
    window.$RefreshRuntime$.register(type, '"app\\\\recipes\\\\components\\\\RecipesDashboard\\\\RecipesDashboard.tsx"' + id);
  };
  window.$RefreshSig$ = window.$RefreshRuntime$.createSignatureFunctionForTransform;
}
var prevRefreshReg;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1706818580005.1858";
}
function RecipesDashboard() {
  _s4();
  const recipes = useRecipes();
  return /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("section", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(If_default, { condition: recipes.length === 0, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(If_default.Then, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(EmptyRecipesDashboard, {}, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(If_default.Else, { children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)("div", { children: /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(Slider_default, { children: recipes.map((recipe) => /* @__PURE__ */ (0, import_jsx_dev_runtime10.jsxDEV)(RecipeCard, { id: recipe.id, ingredients: recipe.ingredients, isExternalSrc: recipe.isExternalSrc, title: recipe.title, image: recipe.image }, recipe.id, false, {
      fileName: "app/recipes/components/RecipesDashboard/RecipesDashboard.tsx",
      lineNumber: 38,
      columnNumber: 38
    }, this)) }, void 0, false, {
...
_s4(RecipesDashboard, "N4RQc5Xqb7BGQnbAJDB2oBbDIck=", false, function() {
  return [useRecipes];
});
_c10 = RecipesDashboard;
var _c10;
$RefreshReg$(_c10, "RecipesDashboard");
window.$RefreshReg$ = prevRefreshReg;
window.$RefreshSig$ = prevRefreshSig;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704756518989.6587";
}
var meta = () => {
  return [{
    title: "New Remix App"
...
function Index() {
  return /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)("main", { className: "section-container pt-16", children: /* @__PURE__ */ (0, import_jsx_dev_runtime11.jsxDEV)(RecipesDashboard, {}, void 0, false, {
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=/build/routes/_index-JSM7AXRM.js.map
