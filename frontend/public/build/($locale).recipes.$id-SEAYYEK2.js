import {
  recipes_service_default
} from "/build/_shared/chunk-T3WBZNON.js";
import {
  Button,
  C,
  D,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703674779649.3298";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703852794089.6177";
}
function WishlistButton({
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(Button, { ...props, type: "button", intent: "secondary", onClick, children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime4.jsxDEV)(HeartIcon_default, { className: cx("h-5 w-5", {
      "text-red-600": isWishlist
    }) }, void 0, false, {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1704203887069.07";
}
function RecipeWishlistButton({
  ...
  const onClick = async () => {
    ...
    if (createRecipe) {
      ...
      console.log(input);
      const data = await recipes_service_default.createRecipeAndAddToWishList({
        ...input,
        isWishList: true
      });
      console.log(data);
...
_s(RecipeWishlistButton, "3r9eYsJ9DVBrzdsbJrjaiQEaKBA=", false, function() {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703852374988.229";
}
function Recipe({
  title,
  ingredients,
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703792191523.2856";
}
function Index() {
  _s2();
  const {
...
//# sourceMappingURL=/build/($locale).recipes.$id-SEAYYEK2.js.map
