...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630108.93";
}
var BaseCache = class {
  constructor(timeout) {
  ...
  get({ query, variables }) {
    ...
    return (_b = (_a2 = this.cache.get(internalKey)) == null ? void 0 : _a2.value) != null ? _b : null;
  }
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630109.0222";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703208236469.343";
}
var HTTP_ERROR = {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630109.0725";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630109.114";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630109.1516";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630108.9763";
}
var _Cache = class {
  static Short() {
    if (!_Cache.shortCache) {
      _Cache.shortCache = new CacheShort();
    }
    return _Cache.shortCache;
  }
  static Default() {
    if (!_Cache.defaultCache) {
      _Cache.defaultCache = new CacheDefault();
    }
    return _Cache.defaultCache;
  }
  static Long() {
    if (!_Cache.longCache) {
      _Cache.longCache = new CacheLong();
    }
    return _Cache.longCache;
  }
  static Custom(timeout) {
    if (!_Cache.customCaches.has(timeout)) {
      _Cache.customCaches.set(timeout, new CacheCustom(timeout));
    }
    return _Cache.customCaches.get(timeout);
  }
  static invalidateByDomain(domain) {
    var _a2, _b, _c;
    (_a2 = _Cache.shortCache) == null ? void 0 : _a2.forceInvalidationByDomain(domain);
    (_b = _Cache.longCache) == null ? void 0 : _b.forceInvalidationByDomain(domain);
    (_c = _Cache.defaultCache) == null ? void 0 : _c.forceInvalidationByDomain(domain);
    _Cache.customCaches.forEach((cache) => {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703766681660.7637";
}
var Mutation = class {
  ...
  getDomain() {
    ...
    const endNameIndex = queryWithoutName.indexOf("(") > -1 ? queryWithoutName.indexOf("(") : queryWithoutName.indexOf("{");
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703792204229.414";
}
var Query = class {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703171888858.1877";
}
var Http = class {
  constructor(base = ((_a2) => (_a2 = process.env.API_URL) != null ? _a2 : "")()) {
    this.base = base;
    this.base = base;
  }
  query(query, options) {
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703119630109.4897";
}
var _a;
var client = new Http((_a = process.env.API_URL) != null ? _a : "");

// app/http/utils/index.ts
if (import.meta) {
  import.meta.hot = createHotContext(
    //@ts-expect-error
    "app/http/utils/index.ts"
  );
  import.meta.hot.lastModified = "1703119630109.5273";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703790726125.2258";
}
var handleGqlErrors = (errors) => {
  ...
  if (errors) {
    ...
    throw new Response(formattedErrors, {
      status: ((_b = (_a2 = errors[0].extensions) == null ? void 0 : _a2.originalError) == null ? void 0 : _b.statusCode) || 500
    });
  }
};
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703851496625.2441";
}
...
`;
var CreateRecipeMutation_default = CREATE_RECIPE_MUTATION;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703816103960.152";
}
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703766516529.918";
}
...
`;
var RecipesQuery_default = RECIPES_QUERY;
...
if (import.meta) {
  ...
  import.meta.hot.lastModified = "1703851991261.9136";
}
var RecipesService = class {
  ...
  async getRecipesByUserId() {
    const { data } = await this.client.query(RecipesQuery_default);
    return (data == null ? void 0 : data.recipes) || [];
  }
  async createRecipeAndAddToWishList(input) {
    const { data, errors } = await this.client.mutate(CreateRecipeMutation_default, {
      variables: {
        input
      }
    });
    handleGqlErrors(errors);
    return data == null ? void 0 : data.createRecipe;
  }
};
var recipes_service_default = RecipesService.instance;

export {
  recipes_service_default
};
//# sourceMappingURL=/build/_shared/chunk-T3WBZNON.js.map
